...
- Developed a novel 4D mesh generative model for personalized cardiac anatomy reconstruction.
- Demonstrated improved accuracy in representing normal heart dynamics compared to baseline models.
